...
var explosion_scene = preload("res://fogos3d.tscn")

#Variável para carregar cena de subida
var rising_scene = preload("res://fogos_subindo3d.tscn")
...
func _input(event):
	...
	if Input.is_mouse_button_pressed(BUTTON_LEFT):
		...
		rising_instance.connect("explodir",self,"explodir_antes",[rising_instance.get_node("Area")])
...
func explodir_antes(area):
	...
	print(subindo.translation)
	#Apaga o losango branco
	subindo.get_node('MeshInstance').visible = false
	...
	explosion_instance.translation = subindo.translation
	#Adiciona o novo nó na árvore
	var stage_node=get_parent()
